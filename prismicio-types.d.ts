...
type ContentPostDocumentDataSlicesSlice = ImageBlockSlice | TextBlockSlice;

/**
 * Content for Content post documents
 */
interface ContentPostDocumentData {
  /**
   * Title field in *Content post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: content_post.title
   * - **Tab**: Main
  ...
  /**
   * Date field in *Content post*
   *
   * - **Field Type**: Date
   * - **Placeholder**: *None*
   * - **API ID Path**: content_post.date
   * - **Tab**: Main
  ...
  /**
   * Hover Image field in *Content post*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_post.hover_image
   * - **Tab**: Main
  ...
  /**
   * Slice Zone field in *Content post*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: content_post.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<ContentPostDocumentDataSlicesSlice> /**
   * Meta Title field in *Content post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: content_post.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  ...
  /**
   * Meta Description field in *Content post*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: content_post.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  ...
  /**
   * Meta Image field in *Content post*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_post.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Content post document from Prismic
 *
 * - **API ID**: `content_post`
 * - **Repeatable**: `true`
 ...
 */
export type ContentPostDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<ContentPostDocumentData>,
    "content_post",
    Lang
  >;
...
interface SettingsDocumentData {
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.linkdein
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  linkdein: prismic.LinkField /**
  ...
  /**
   * Meta Descrption field in *Settings*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.meta_descrption
   * - **Tab**: SEO And Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_descrption: prismic.KeyTextField;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ContentPostDocument,
      ContentPostDocumentData,
      ContentPostDocumentDataSlicesSlice,
      HomepageDocument,
